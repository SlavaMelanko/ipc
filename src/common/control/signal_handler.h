...
// async-signal-unsafe handler) and waits for either on a dedicated thread
// via sigwait(), calling controller.Stop() from that thread's ordinary
// context once one arrives.
//
